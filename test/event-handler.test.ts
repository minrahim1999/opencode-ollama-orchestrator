...
import { looksLikeTaskRequest, shouldIgnore } from "../src/core/event-handler.js";
...
describe("looksLikeTaskRequest", () => {
  ...
  it("weak + strong = accept", () => {
    expect(looksLikeTaskRequest("please help me build a login page")).toBe(true);
  });
...
describe("shouldIgnore", () => {
  const ignoredWords = ["ok", "thanks", "thank you", "got it", "nice", "cool", "lol", "haha", "👍", "✅"];
